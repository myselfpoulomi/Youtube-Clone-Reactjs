...
function Navbar({setSidebar}) {
  return (
    <nav className='flex items-center py-[10px] px-[2%] justify-between shadow-md
bg-[#fff] sticky top-0 z-10'>
        <div className='flex items-center'>
           <img src={menu_icon}alt="" onClick={()=>{
        ...
        <div className='flex items-center'>
            ...
            <input type="text" placeholder='Search' className='w-[500px] border-0 outline-0 bg-transparent'/>
